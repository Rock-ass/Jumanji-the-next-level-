...
//Title Screen
playSound("StardustSpeedway2.mp3", true);
...
onEvent("SelSonic", "click", function(event) {
  ...
  setImageURL("ring", "https://steamusercontent-a.akamaihd.net/ugc/858354616142808703/AB7BC1BB4E4951124F9D23304887241651CACCF7/");
...
function Begin() {
  stopSound("StardustSpeedway2.mp3");
  stopSound("BlueSpheresLoop.mp3");
  playSound("MenuAccept.mp3", false);
  playSound("assets/Go.mp3", false);
...
function UnlockMSonic() {
  ...
  if (MSU == "shelly oberon") {
    stopSound("BlueSpheresLoop.mp3");
    playSound("assets/MedalCaught.mp3", false);
    sanic = 1;
    hideElement("SelMSU");
...
function Awards() {
  if (PSonic == 1 && AS == 0) {
    showElement("50Sonic");
    playSound("assets/Continue.mp3", false);
    AS = 1;
    sanic = 2;
  }
  if (PTails == 1 && AT == 0) {
